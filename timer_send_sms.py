...
from credentials import cellphone, twilio_account, twilio_token, twilio_number
...
schedule.every().day.at("08:00").do(send_message, GOOD_MORNING_QUOTES)

# send a message in the evening
schedule.every().day.at("20:00").do(send_message, GOOD_EVENING_QUOTES)

# testing
schedule.every().day.at("15:34").do(send_message, GOOD_EVENING_QUOTES)
